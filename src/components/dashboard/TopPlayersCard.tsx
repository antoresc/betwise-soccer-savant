...
const TopPlayersCard: React.FC<TopPlayersCardProps> = ({ players }) => {
  return (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span 
                    className={cn(
                      ...
                      player.form === "↑" ? "bg-bet-success/20 text-bet-success" :
                      player.form === "↓" ? "bg-bet-danger/20 text-bet-danger" :
                      "bg-bet-muted text-muted-foreground"
                    )}
                  >
                    {player.form}
                  </span>
