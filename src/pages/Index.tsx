  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [matchesData, playersData, tipsData] = await Promise.all([FootballAPI.getUpcomingMatches(activeCompetition.id), FootballAPI.getPlayers(activeCompetition.id), FootballAPI.getBettingTips(activeCompetition.id)]);
      ...
      <div className="space-y-6 animate-fade-in">
        <div className="relative overflow-hidden p-4 rounded-lg bg-gradient-to-r from-[#0D0630] via-[#18314F] to-[#384E77] animate-gradient-shift">
          <div className="relative z-10">
            ...
            <p className="text-sm text-white/80 mt-1 max-w-2xl md:text-base">
